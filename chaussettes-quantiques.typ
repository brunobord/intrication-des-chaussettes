...
#show: elsearticle.with(
  title: "Hypothèse de l'Intrication Quantique, une hypothèse de réponse au grand mystère de la disparition d'une chaussette par paire.",
  authors: (
    (
      name: "Bruno Bord",
...
Pourquoi ne perd-on jamais qu'une seule chaussette par paire et surtout, comment se fait-il que cette paire disparaisse à tout jamais sans aucun espoir d'être retrouvée ?
